...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    private static String accessKey = "p8oDd-P5Xsd_ZNhEgR38l-TMI2CJUak3saJSWrpO";
    private static String secretKey = "VX1mQRzOpn-mlL2ZwFWJ-yMLJVWIN1JgYpxEY3BE";
    private static String bucket = "csu-bailan";
    private static String origin="https://portal.qiniu.com/cdn/domain/rde7cnrpt.hn-bkt.clouddn.com";
